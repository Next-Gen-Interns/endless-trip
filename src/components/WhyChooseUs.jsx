...
"
            >
              {/* Icon */}
              <div className="text-5xl mb-6 text-orange-500 transition-colors duration-300 group-hover:text-purple-700">
                <i className={item.icon}></i>
              </div>

              {/* Title */}
              <h3 className="text-3xl font-bold text-gray-800 drop-shadow-sm mb-4 ">
                {item.title}
              </h3>
